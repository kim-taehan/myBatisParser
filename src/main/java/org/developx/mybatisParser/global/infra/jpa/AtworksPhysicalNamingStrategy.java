package org.developx.mybatisParser.global.infra.jpa;
...
public class AtworksPhysicalNamingStrategy implements PhysicalNamingStrategy {
    ...
    public Identifier toPhysicalTableName(Identifier name, JdbcEnvironment jdbcEnvironment) {
        ...
        String format = tableName.startsWith("tb_") ? "%s" : "tb_%s";
        Identifier identifier = new Identifier(String.format(format, tableName), name.isQuoted());
